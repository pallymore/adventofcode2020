...
async function solution() {
  ...
  const allergenIngredient = {}; // allergen -> ingredient
  ...
  const dangerList = Object.keys(allergenIngredient)
    .sort()
    .map((allergen) => allergenIngredient[allergen]);

  return dangerList.join(",");
}
